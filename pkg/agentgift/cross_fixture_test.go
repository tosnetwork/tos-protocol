...
func TestRustAgentAccountFixtureIsAcceptedByIndependentGoVerifier(t *testing.T) {
	...
	if err != nil || json.Unmarshal(raw, &fixture) != nil || fixture.Schema != "tos.agent-gift.rust-fixture.v1" || "tvm-cell-sha256:"+fixture.CodeHash != AgentAccountCodeHash {
