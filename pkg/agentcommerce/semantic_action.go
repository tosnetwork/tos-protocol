...
func buildSemanticActionRegistry() map[string]SemanticActionEntry {
	entries := []SemanticActionEntry{
		...
		entry("capability.install", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("artifact_version_digest", SemanticDigest32), f("installation_id", SemanticID), f("target_store_digest", SemanticDigest32), f("expected_inventory_revision", SemanticU64)),
		entry("capability.update", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("predecessor_artifact_digest", SemanticDigest32), f("artifact_version_digest", SemanticDigest32), f("installation_id", SemanticID), f("expected_inventory_revision", SemanticU64)),
		entry("capability.rollback", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("current_artifact_digest", SemanticDigest32), f("rollback_artifact_digest", SemanticDigest32), f("installation_id", SemanticID), f("expected_inventory_revision", SemanticU64)),
		entry("capability.remove", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("artifact_version_digest", SemanticDigest32), f("installation_id", SemanticID), f("expected_inventory_revision", SemanticU64), f("deletion_generation", SemanticU64)),
		entry("capability.gc", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("artifact_version_digest", SemanticDigest32), f("tombstone_digest", SemanticDigest32), f("reference_scan_root", SemanticDigest32), f("deletion_generation", SemanticU64)),
		entry("capability.admit", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("admission_id", SemanticID), f("artifact_version_digest", SemanticDigest32), f("admission_body_digest", SemanticDigest32)),
		entry("capability.suspend", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("admission_id", SemanticID), f("expected_admission_revision", SemanticU64), f("revocation_generation", SemanticU64)),
		entry("capability.resume", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("admission_id", SemanticID), f("expected_admission_revision", SemanticU64), f("revocation_generation", SemanticU64)),
		entry("capability.revoke", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("admission_id", SemanticID), f("expected_admission_revision", SemanticU64), f("revocation_generation", SemanticU64)),
		entry("capability.promotion.activate", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("promotion_id", SemanticID), f("artifact_version_digest", SemanticDigest32), f("promotion_body_digest", SemanticDigest32)),
		entry("capability.promotion.revoke", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("promotion_id", SemanticID), f("expected_promotion_revision", SemanticU64), f("revocation_generation", SemanticU64)),
		entry("capability.source-search.record", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("requirement_digest", SemanticDigest32), f("source_policy_digest", SemanticDigest32), f("source_attempt_set_digest", SemanticDigest32)),
		entry("capability.local-draft.create", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("requirement_digest", SemanticDigest32), f("sourcing_decision_digest", SemanticDigest32), f("draft_artifact_digest", SemanticDigest32)),
		entry("owner.command.submit", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("resolution_namespace", SemanticDigest32),
			f("command_kind", SemanticKind), f("target_object_kind", SemanticKind), f("target_object_id", SemanticID),
			f("exact_parameter_digest", SemanticDigest32), f("governing_policy_digest", SemanticDigest32),
			f("expected_target_revision", SemanticU64), f("command_instance_id", SemanticID)),
		entry("owner.command.resolve", SuccessorTerminal, f("owner_id", SemanticID), f("agent_id", SemanticID), f("resolution_namespace", SemanticDigest32), f("command_effect_digest", SemanticDigest32), f("target_resolution_state", SemanticState)),
		entry("report.generate", SuccessorNone, f("owner_id", SemanticID), f("agent_id", SemanticID), f("report_series_id", SemanticDigest32), f("source_snapshot_digest", SemanticDigest32), f("correction_revision", SemanticU64)),
