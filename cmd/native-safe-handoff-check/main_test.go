...
func TestDecodeBundleRejectsUnknownAndTrailingJSON(t *testing.T) {
	base := `{"schema":"tos.service.safe-handoff.v1","network":{},"quote_request":{},"quote_package":{},"execution_signer_public_key_hex":"","escrow_address":"","expected_escrow_code_hash":"","receipt_boc_base64":"","settlement_query_id":1,"settlement_signature_hex":""}`
